...
RooSpinZero_3D_pp_VH::RooSpinZero_3D_pp_VH(const RooSpinZero_3D_pp_VH& other, const char* name) :  
...
vector<TLorentzVector> RooSpinZero_3D_pp_VH::Calculate4Momentum(float Mx,float M1,float M2,float theta,float theta1,float theta2,float _Phi1_,float _Phi_) const 
{
